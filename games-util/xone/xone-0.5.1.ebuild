...
src_unpack() {
	...
	cabextract -F FW_ACC_00U.bin -d "${S}/xone_firmware_02fe" \
		"${DISTDIR}/2ea9591b-f751-442c-80ce-8f4692cdc67b_6b555a3a288153cf04aec6e03cba360afe2fce34.cab" > /dev/null || die
	cabextract -F FW_ACC_00U.bin -d "${S}/xone_firmware_02e6" \
		"${DISTDIR}/1cd6a87c-623f-4407-a52d-c31be49e925c_e19f60808bdcbfbd3c3df6be3e71ffc52e43261e.cab" > /dev/null || die
	cabextract -F FW_ACC_CL.bin -d "${S}/xone_firmware_02f9" \
		"${DISTDIR}/1dbd7cb4-53bc-4857-a5b0-5955c8acaf71_9081931e7d664429a93ffda0db41b7545b7ac257.cab" > /dev/null || die
	cabextract -F FW_ACC_BR.bin -d "${S}/xone_firmware_091e" \
		"${DISTDIR}/aeff215c-3bc4-4d36-a3ea-e14bfa8fa9d2_e58550c4f74a27e51e5cb6868b10ff633fa77164.cab" > /dev/null || die
}
