...
EPYTEST_PLUGINS=( aiomisc-pytest pytest-rerunfailures )
...
python_test() {
	local EPYTEST_DESELECT=(
		# fail with default MEMLOCK limit
		"tests/test_aio_context.py::test_aio_context[caio.linux_uring]"
		"tests/test_aio_context.py::test_aio_context[linux_uring[sqpoll=True]]"
	)
