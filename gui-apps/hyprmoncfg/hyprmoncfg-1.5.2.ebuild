...
src_compile() {
	...
	ldflags="-X github.com/crmne/hyprmoncfg/internal/buildinfo.Version=${PV} -X github.com/crmne/hyprmoncfg/internal/buildinfo.Commit=36e9dcd -X github.com/crmne/hyprmoncfg/internal/buildinfo.Date=${build_date}"
