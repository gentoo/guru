...
RDEPEND="
	...
	<dev-python/dropbox-12.2.2[${PYTHON_USEDEP}]
...
EPYTEST_DESELECT=(
	...
	tests/offline/test_errorhandling.py::test_get_session_lookup_error_msg
	tests/offline/test_cli.py::test_log_clear
	tests/offline/test_cli.py::test_log_show
)
