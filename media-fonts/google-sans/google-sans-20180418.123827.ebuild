...
# Note: The package version is based on <https://flutter.googlesource.com/gallery-assets/+log/refs/heads/master/lib/fonts>
# To get a new package version, inspect element the "X days/months/years ago" text and get the title attribute in HTML.
