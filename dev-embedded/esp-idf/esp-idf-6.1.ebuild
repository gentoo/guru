...
# See https://dl.espressif.com/dl/esp-idf/espidf.constraints.v6.1.txt for information about version dependencies
...
LICENSE="Apache-2.0"
LICENSE+=" BSD BSD-2 GPL-2 MIT" # license of bundled components
SLOT="0/$(ver_cut 1-2)"
KEYWORDS="~amd64"
...
EOF
	...
	if use riscv32; then
		...
		install_tool riscv32-esp-elf/picolibc/riscv32-esp-elf
	fi
