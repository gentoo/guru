...
pkg_postinst() {
	...
	# The most notable changes of river 0.3.14 -> river 0.3.15 are the
	# new wayland-protocols that are part of wlroots-0.20.0.
	ewarn "- Support for the new screen capture protocols has been"
	ewarn "added to xdg-desktop-portal-wlr in version 0.8.1."
}
