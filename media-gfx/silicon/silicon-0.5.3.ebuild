...
SRC_URI="
	https://github.com/Aloxaf/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
RESTRICT="mirror"
PATCHES=(
	"${FILESDIR}/silicon-0.5.3-cargo-toml-version.patch"
	"${FILESDIR}/silicon-0.5.3-remove-pathfinder_simd-patch.patch"
)
