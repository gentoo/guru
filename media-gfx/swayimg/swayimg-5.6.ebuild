...
SLOT="0"
KEYWORDS="~amd64"
IUSE="avif bash-completion drm exif ffmpeg gif heif jpeg jpeg2k jpegxl png raw sixel svg test tiff +wayland webp X"
REQUIRED_USE="
	${LUA_REQUIRED_USE}
	|| ( drm wayland )
"
