...
EGO_SUM=(
	...
	"github.com/jwalton/gchalk v1.2.1/go.mod"
	...
	"github.com/spf13/afero v1.7.1/go.mod"
...
SRC_URI="https://github.com/noborus/ov/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}
"
...
src_compile() {
	go build -v -x -o ${PN} -ldflags="-X main.Version=${PV}" || die
}
