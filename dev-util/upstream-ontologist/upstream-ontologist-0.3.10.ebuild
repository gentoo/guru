...
CRATES="
	...
	byteorder@1.5.0
	bytes@1.11.1
	cargo-credential-libsecret@0.5.4
	cargo-credential-macos-keychain@0.4.19
	cargo-credential-wincred@0.4.19
	...
	deb822-derive@0.3.1
	deb822-fast@0.2.3
	deb822-lossless@0.5.8
	debbugs@0.1.8
	debcargo@2.8.1
	debian-changelog@0.2.14
	debian-control@0.2.17
...
SRC_URI="https://github.com/jelmer/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
DOCS=( docs/. AUTHORS {CODE_OF_CONDUCT,README,SECURITY}.md )
