...
MY_PV="20220905-102802-7d4b8249"
MY_P="${PN}-${MY_PV}"
...
SUBMODULES=(
	...
	"harfbuzz github harfbuzz https://github.com/harfbuzz/harfbuzz 4a1d891c6317d2c83e5f3c2607ec5f5ccedffcde"
	"libssh-rs-tmp github crates https://github.com/wez/libssh-rs d36e5648274063c187968fd5ce0b1a7aa350a025"
	"xcb github crates https://github.com/wez/rust-xcb a85a4cf8937898b1da972367df4648143ede38ea"
	"xcb-imdkit github crates https://github.com/wez/xcb-imdkit-rs ede7c71b85fe2537efef6cf999a45690316211cf"
	"xcb-imdkit-vendor github crates https://github.com/fcitx/xcb-imdkit 30e2f16f9a8b0e338e25ce5e3643809a07ad41f0"
...
src_prepare() {
	...
	cp -r "${S}"/deps/crates/xcb-imdkit-vendor/* "${S}/deps/crates/xcb-imdkit/deps/xcb-imdkit" || die
	rm -rf "${S}/deps/crates/libssh-rs-tmp" || die
	rm -rf "${S}/deps/crates/libssh" || die
	rm -rf "${S}/deps/crates/xcb-imdkit-vendor" || die
	echo '{"files":{}}' > "${S}/deps/crates/libssh-rs/.cargo-checksum.json" || die
	echo '{"files":{}}' > "${S}/deps/crates/libssh-rs-sys/.cargo-checksum.json" || die
	echo '{"files":{}}' > "${S}/deps/crates/xcb/.cargo-checksum.json" || die
	echo '{"files":{}}' > "${S}/deps/crates/xcb-imdkit/.cargo-checksum.json" || die
