...
EGO_SUM=(
	...
	"github.com/go-enry/go-enry/v2 v2.7.1/go.mod"
	...
	"github.com/go-openapi/strfmt v0.20.2/go.mod"
	...
	"github.com/shurcooL/githubv4 v0.0.0-20210922025249-6831e00d857f/go.mod"
	...
	"go.mongodb.org/mongo-driver v1.7.2/go.mod"
	...
	"go.riyazali.net/sqlite v0.0.0-20210830064319-b3ba44e2587a/go.mod"
...
HOMEPAGE="https://github.com/askgitdev/askgit"
SRC_URI="
	https://github.com/askgitdev/askgit/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}
"
