...
EGO_SUM=(
	...
	"github.com/augmentable-dev/vtab v0.0.0-20210915151038-6572bfc4e313/go.mod"
	...
	"github.com/charmbracelet/bubbles v0.10.2/go.mod"
	...
	"github.com/dnaeon/go-vcr/v2 v2.0.1/go.mod"
	...
	"github.com/go-enry/go-enry/v2 v2.8.0/go.mod"
	...
	"github.com/libgit2/git2go/v33 v33.0.7/go.mod"
	...
	"github.com/shurcooL/githubv4 v0.0.0-20220115235240-a14260e6f8a2/go.mod"
	...
	"go.riyazali.net/sqlite v0.0.0-20210707161919-414349b4032a/go.mod"
	"go.riyazali.net/sqlite v0.0.0-20211205072512-8da54dbc2d28"
	"go.riyazali.net/sqlite v0.0.0-20211205072512-8da54dbc2d28/go.mod"
...
SRC_URI="
	https://github.com/mergestat/mergestat/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}
"
...
src_prepare() {
	...
	rm pkg/sqlite/sqlite3{.c,.h,ext.h} || die
	default
}
...
src_compile() {
	...
	ego build \
		--buildmode=c-shared \
		-ldflags '-extldflags -Wl,-soname,libmergestat.so' \
		-tags="${tags},shared" \
		-v \
		-x \
		-o "libmergestat.so" \
...
src_install() {
	...
	newbashcomp mergestat.bash mergestat
	insinto /usr/share/fish/vendor_completions.d
	doins mergestat.fish
	insinto /usr/share/zsh/site-functions
	newins mergestat.zsh _mergestat
}

src_test() {
	ego test -x -v -tags="sqlite_vtable,vtable,sqlite_json1,system_libgit2,static" ./... || die
}
