...
openur.ffmpegcore@5.4.0.37
openur.ffprobestatic@9.0.1.492
...
src_test() {
	filters=(
		'FullyQualifiedName!~NzbDrone.Common.Test.Http.HttpClientFixture<ManagedHttpDispatcher>.should_call_interceptor'
		'FullyQualifiedName!~NzbDrone.Common.Test.Http.HttpClientFixture<ManagedHttpDispatcher>.should_clear_request_cookie'
		...
		'FullyQualifiedName!~NzbDrone.Common.Test.Http.HttpClientFixture<ManagedHttpDispatcher>.should_throw_on_unsuccessful_status_codes'
	)
