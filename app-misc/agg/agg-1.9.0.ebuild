...
DESCRIPTION="Command-line tool for generating animated GIF files from asciicast files"
HOMEPAGE="
...
LICENSE="GPL-3+"
LICENSE+=" GPL-2"  # gifsicle
LICENSE+=" Apache-2.0 ISC MIT"  # ring
# Dependent crate licenses
LICENSE+="
	AGPL-3+ Apache-2.0 BSD-2 BSD CDLA-Permissive-2.0 GPL-3+ ISC MIT
