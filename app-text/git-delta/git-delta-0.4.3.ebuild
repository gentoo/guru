...
RESTRICT="mirror"
LICENSE="Apache-2.0 BSD-2 CC0-1.0 ISC LGPL-3+ MIT ZLIB"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="bash-completion zsh-completion"

DEPEND=""
RDEPEND="!app-text/delta"
...
src_install() {
	...
	if use bash-completion ; then
		newbashcomp etc/completion/completion.bash delta
	fi

	if use zsh-completion ; then
		insinto /usr/share/zsh/site-functions
		newins etc/completion/completion.zsh _delta
	fi
}
