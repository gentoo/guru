...
SRC_URI="
	...
	https://github.com/gentoo-crate-dist/i3status-rust/releases/download/v${PV}/${P}-crates.tar.xz
...
PATCHES=( "${FILESDIR}"/${PN}-0.35.0-gitless.patch )
...
src_prepare() {
	default
	local COMMIT="b4212f7cb944608737054f789a91271db418d2fa"
...
src_configure() {
	...
	cargo_src_configure $(usev !pulseaudio '--no-default-features')
}
...
pkg_postinst() {
	...
	optfeature "VPN support" net-vpn/mullvadvpn-app
