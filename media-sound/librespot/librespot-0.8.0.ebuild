...
SRC_URI="
	https://github.com/librespot-org/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
LICENSE="MIT"
...
IUSE="+alsa gstreamer jack portaudio pulseaudio +rodio rodio-jack sdl"
...
QA_FLAGS_IGNORED="/usr/bin/librespot"
...
src_configure() {
	local myfeatures=(
		...
		$(usev rodio-jack rodiojack-backend)
