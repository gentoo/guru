...
# Ran the following commands in the OpenUtau project directory
# NUGET_PACKAGES="$(pwd)/.cache/nuget_packages" dotnet restore --verbosity Detailed
# gdmt restore
# See https://wiki.gentoo.org/wiki/Dotnet/Devguide for more info
NUGETS="
asyncio@0.1.69
...
avalonia.headless.xunit@11.0.4
avalonia.headless@11.0.4
...
src_test() {
	dotnet-pkg-base_test OpenUtau.Test
}
