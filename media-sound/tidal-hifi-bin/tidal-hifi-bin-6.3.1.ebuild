...
# This ebuild is dedicated to Mavy, the late niece of tidal-hifi's maintainer. (Mastermindzh)
...
pkg_postinst() {
	xdg_pkg_postinst
	elog "As with this version's codename, (6.3.1-mavy) this ebuild is dedicated to Mavy,"
