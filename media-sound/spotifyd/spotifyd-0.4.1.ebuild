...
SRC_URI="https://github.com/Spotifyd/spotifyd/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz
	${CARGO_CRATE_URIS}"
...
LICENSE+=" Apache-2.0 ISC MIT MPL-2.0 Unicode-3.0 openssl BSD"
SLOT="0"
KEYWORDS="~amd64"
IUSE="+alsa pulseaudio portaudio rodio dbus jack"
...
src_configure() {
	local myfeatures=(
		...
		$(usev jack rodiojack_backend)
		$(usev dbus dbus_mpris)
	)
